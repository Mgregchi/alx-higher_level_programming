...
def matrix_mul(m_a, m_b):
    ...
    Args: 
	m_a: First list matrix
	m_b: Second list matrix

    Raises:
	TypeError: If m_a or/and m_b are not list(s) with integers or floats

    Returns the result of multiplying m_a and m_b
    """
